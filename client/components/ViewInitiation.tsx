...
<div style={{borderRadius:"10px"}}>
  <div className={styles.view} style={{backgroundColor:"ButtonHighlight",paddingLeft:"29em"}}>
      <h2>Initiation Phase</h2>
        ...
        <h5>Start Date: </h5>
        <p className={styles.paragraph}>{projectInfo.startDate}</p>
        <h5>Finish Date: </h5>
        <p className={styles.paragraph}>{projectInfo.finishDate}</p>
        <h5>Objectives: </h5>
        <p className={styles.paragraph}>{projectInfo.objectives}</p>
        <h5>Project Manager: </h5>
        <p className={styles.paragraph}>{projectInfo.projectManager}</p>
        <h5>Budget: </h5>
        <p className={styles.paragraph}>{projectInfo.budget}</p>
        <h5>Scope Statements:</h5>
        <p className={styles.paragraph}>{projectInfo.scopeStatements}</p>
       <br/>
        <div style={{textAlign:"center" ,margin:"5em"}}>
          ...
          <div style={{ textAlign: "center", border: "4px solid #0d4d64",borderRadius:"50px",padding:"10px",backgroundColor:"snow"}}>
            <p style={{marginLeft: "4em" ,color:"#0d4d64"}}>Are you sure you want to delete Initiation Phase?</p>
